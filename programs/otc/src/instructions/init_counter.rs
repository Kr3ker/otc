...
const COMP_DEF_OFFSET: u32 = comp_def_offset("init_counter");
use crate::state::Counter;
use crate::{SignerAccount, ID, ID_CONST};

pub fn handler(ctx: Context<InitCounter>, computation_offset: u64, nonce: u128) -> Result<()> {
...
pub fn init_comp_def_handler(ctx: Context<InitInitCounterCompDef>) -> Result<()> {
